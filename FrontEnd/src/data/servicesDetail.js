...
export const ServiciosDetalle = [
  {
    ...
    Subtitle: "Tu presencia digital, hecha a medida",
    ...
    Features: [
      ...
      "Portafolios y blogs profesionales",
  ...
  },
  {
    ...
    Subtitle: "Soluciones digitales que impulsan tu empresa",
  ...
  },
  {
    ...
    Image: WebService,
    Title: "Sistemas ERP",
    Subtitle: "Automatiza y organiza tu negocio",
...
export const serviciosIncluye = [
  "Cotización especial para cada proyecto y negocio",
  "Diseño personalizado con páginas de referencia y prototipos",
  "Dominio propio: tunegocio.com",
  "Correo profesional: contacto@tunegocio.com",
  "Sistema Web y ERP cuentan con más revisiones y cambios extra"
];
